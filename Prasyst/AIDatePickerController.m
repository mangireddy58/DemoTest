...
//    [datePickerController.datePicker setMaximumDate:[NSDate date]];//Maximum Date
//    [datePickerController.datePicker setMinimumDate:[NSDate date]];//Minimum Date
...
- (void)viewDidLoad {
    ...
    [_cancelButton setTitle:[NSLocalizedString(@"cancel", nil) capitalizedString] forState:UIControlStateNormal];
    ...
    [_selectButton setTitle:[NSLocalizedString(@"select", nil) capitalizedString] forState:UIControlStateNormal];
    ...
    switch ((VIEWHEIGHT == 568)?1:((VIEWHEIGHT == 667)?2:3)) {
        case 1:{
            _selectButton.titleLabel.font = LFONT_20;
            _cancelButton.titleLabel.font = LFONT_20;
            [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[_dismissButton][_datePickerContainerView]-10-[_buttonContainerView(48)]-5-|"
                                                                              options:0
                                                                              metrics:nil
                                                                                views:views]];
        }
            break;
        case 2:{
            _selectButton.titleLabel.font = LFONT_22;
            _cancelButton.titleLabel.font = LFONT_22;
            [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[_dismissButton][_datePickerContainerView]-10-[_buttonContainerView(54)]-5-|"
                                                                              options:0
                                                                              metrics:nil
                                                                                views:views]];
        }
            break;
        default:{
            _selectButton.titleLabel.font = LFONT_24;
            _cancelButton.titleLabel.font = LFONT_24;
            [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[_dismissButton][_datePickerContainerView]-10-[_buttonContainerView(58)]-5-|"
                                                                              options:0
                                                                              metrics:nil
                                                                                views:views]];
        }
